...
# Directorio
setwd('D:/fvillarreal/Programacion Sector Real/Otros indicadores/Afiliados IESS')



# Datos: Empleo registrado por rama de actividad
df <- read_excel('Datos/Indicadores Laborales_Empleo_03_22.xlsx',
                 sheet = '1_1_1',
                 skip = 5)
...
saveWorkbook(wb, file = 'Resultados/empleo_iess_2022_03.xlsx', overwrite = TRUE)
